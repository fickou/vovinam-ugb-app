...
CREATE TABLE payments (
  ...
  season_id varchar(36) NOT NULL,
  amount integer NOT NULL,
  payment_type payments_type NOT NULL,
  payment_method payments_method NOT NULL,
  payment_date date NOT NULL,
  month_number integer DEFAULT NULL,
  proof_url text DEFAULT NULL,
  status payments_status DEFAULT 'VALIDATED',
...
CREATE TABLE registrations (
  ...
  registration_fee_paid boolean NOT NULL DEFAULT 0,
...
CREATE INDEX board_members_season_id_idx
ON board_members (season_id);
...
CREATE INDEX expenses_season_id_idx ON expenses (season_id);
...
CREATE INDEX reminders_member_id_idx ON reminders (member_id);
CREATE INDEX reminders_season_id_idx ON reminders (season_id);
